...
ProspliceMatching<-function(HTAfile,RNAfile,Class,Events_HTA_Prosplice,Events_RNA_Prosplice)
{
  ...
  # RNA<-vector(length=nrow(HT))
  # HTA<-vector(length=nrow(HT))
  # 
  # for(jj in 1:nrow(HT))
  # {
  #   print(jj)
  #   RNA_X<-unique(as.data.frame(RNAgrl3$Refgrl[HT[jj,1]])[,"gene_id"])
  #   Info<-unique(as.data.frame(HTAgrl3$Refgrl[HT[jj,2]])[,"transcript_id"])
  #   Info<-unlist(strsplit(Info,"_"))
  #   Info<-Info[c(length(Info)-1,length(Info))]
  #   Info<-paste(Info[1],"_",Info[2],sep="")
  #   HTA[jj]<-Info
  #   RNA[jj]<-RNA_X
  # }
...
Samples<-dir("/home/backup-iscsi/HDD_4/Prosplice_22_12_2014/BAM_v2/",pattern=".bam$")
  
SamplePath<-"/home/backup-iscsi/HDD_4/Prosplice_22_12_2014/BAM_v2/"
fileTransc<-"/home/backup/JuanPablo/HTA-2_0_GTF_Transcripts.gtf"
TxtPath<-"/home/backup/JuanPablo/Prosplice/RNASeq/"
...
setwd("/home/backup/JuanPablo/Prosplice/Arrays/aroma/")
...
# IGV Visualization
EventPointer_IGV(Events_HTA_Prosplice, "CustomGTF", inputFile = "/home/backup/JuanPablo/HTA-2_0_GTF_Transcripts.gtf", 
                 PSR="/home/backup/JuanPablo/HTA-2_0_PSR_Probes.txt", 
                 Junc="/home/backup/JuanPablo/HTA-2_0_Junc_Probes.txt", 
                 PathGTF="/home/backup/JuanPablo/", 
                 EventsFile="/home/backup/JuanPablo/EventsFound.txt", 
                 microarray = "HTA-2_0")
